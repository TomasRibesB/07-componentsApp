    ...
    return (
        <CustomView margin>
            ...
            <Card>
                ...
                renderSectionHeader={({ section }) => <SubTitle text={section.title} bacgroundColor={colors.cardBackground} />}
                stickySectionHeadersEnabled

                SectionSeparatorComponent={Separator}

                ListHeaderComponent={() => <Title text="Personajes" />}
                ListFooterComponent={() => <Title text={`Total de personajes: ${houses.reduce((acc, curr) => acc + curr.data.length, 0)}`} />}
